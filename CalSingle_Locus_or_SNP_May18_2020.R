...
{
  ### perform CD-Ratio method to single SNP
  SNP = pruned$loci_bed
  SNP = scale(SNP)
  sig_part = pruned$sig_part
  p = ncol(SNP)
...
CD_Egger <- function(pruned,num_iteration = 20,V_T1 = NULL,V_T2 = NULL)
{
  ### "pruned" is a list, has "loci_bed" and "sig_part"
  ### loci_bed is the reference panel, n by p
  ### sig_part is the summary statistics, p by 12,
...
CD_GLS <- function(pruned,num_iteration = 20,V_T1 = NULL,V_T2 = NULL)
{
  ### "pruned" is a list, has "loci_bed" and "sig_part"
  ### loci_bed is the reference panel, n by p
  ### sig_part is the summary statistics, p by 12,
...
{
  ### use bisection to search root, which is the MLE of sigma square
